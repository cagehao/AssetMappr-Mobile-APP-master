...
import 'package:asset_mapper/UploadPage/contents/upload_button.dart';
...
import 'package:asset_mapper/UploadPage/contents/upload_type.dart';
import 'package:asset_mapper/UploadPage/contents/separator.dart';
import 'package:asset_mapper/UploadPage/contents/name_content.dart';
import 'package:asset_mapper/UploadPage/contents/address_content.dart';
import 'package:asset_mapper/UploadPage/contents/category_content.dart';
import 'package:asset_mapper/UploadPage/contents/note_content.dart';
...
class UploadPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Upload New Assets", style: TextStyle(fontSize: 20, color: Colors.white),),
      ),
